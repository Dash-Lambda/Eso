...
class BFISpec extends EsoSpec{
  ...
  lazy val baseRes2: Try[String] = getOutputString(BFBase, hworld2)
  ...
  lazy val optRes2: Try[String] = getOutputString(BFOpt, hworld2)
  ...
  lazy val compRes2: Try[String] = getOutputString(BFComp, hworld2)
