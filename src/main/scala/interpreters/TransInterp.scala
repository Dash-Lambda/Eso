...
class TransInterp(trans: Translator, interp: Interpreter) extends Interpreter{
  ...
  def apply(bools: mutable.HashMap[String, (Boolean, String)], nums: mutable.HashMap[String, (Int, String)])(progRaw: String): Try[String] = interp(bools, nums)(trans(progRaw))
}
object TransInterp{
