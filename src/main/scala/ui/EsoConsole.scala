...
import pdoubleprime.PDoublePrime
...
object EsoConsole {
  ...
  val interpVec: Vector[Interpreter] = Vector[Interpreter](FracTran, FracTranpp, ScalaRun, WSManaged, BFManaged, Thue, PDoublePrime)
  ...
  val defBools: Vector[(String, (Boolean, String))] = Vector[(String, (Boolean, String))](
    ...
    "fromPtr" -> (true, "toggle whether output for P'' programs starts at the read head going right or at the end of the tape going left"),
    "startHead" -> (true, "toggle whether the read head starts at the beginning of the initial tape or the right end of the tape for P''"),
    "printNull" -> (false, "toggle whether to print the null/empty character in the output of P'' programs"))
  val defNums: Vector[(String, (Int, String))] = Vector[(String, (Int, String))](
    ...
    "dbTim" -> (0, "debug sleep time, slows down execution when debug is on"),
